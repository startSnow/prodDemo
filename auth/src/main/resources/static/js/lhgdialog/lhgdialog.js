...
dialogTpl =
'<table class="ui_border" style="width:autoheight:auto;background:#fefefe;border-radius:10px;box-shadow: 1px 2px 5px #888888;">' +
	'<tbody>' +
		'<tr>' +
			'<td class="ui_lt"></td>' +
			'<td class="ui_t"></td>' +
			...
			'<td class="ui_c">' +
				...
				'<table class="ui_dialog">' +
					'<tbody>' +
						...
						'<tr>' +
							'<td colspan="2">' +
								'<div class="ui_buttons" style="margin:0px auto;"></div>' +
							'</td>' +
						'</tr>' +
					'</tbody>' +
				'</table>' +
...
lhgdialog.fn = lhgdialog.prototype =
{
	...
	lock: function()
	{
		...
		if( !mask )
		{
			frm = '<iframe src="javascript:\'\'" scrolling="none" style="width:100%;height:100%;position:absolute;' +
